...
foto:
  - src: "/img/vez/unhost/unhost-kostel-4460.jpg"
    alt: "Kostel sv. Petra a Pavla — Unhošť"
    credit: "Foto Hynek Moravec (Wikimedia Commons). Licence CC BY 3.0. Zdroj: https://commons.wikimedia.org/wiki/File:Unhost_kostel_4460.JPG"
    typ: "budova"
---
## Stroj

Hodinový stroj **Václava Kretschmera** z Prahy-Vinohrad **má vlastní, u jiných Krečmerových strojů již podruhé nezopakovanou koncepci**. Vybaven **dvěma samostatnými bicími stroji** (čtvrťovým a hodinovým). Rychlost [odbíjení](/slovnik/odbijeni) regulují **[větrníky](/slovnik/vetrnik) se svislou osou otáčení** roztáčené šnekovým převodem do rychla. Jicí stroj má kontrolní číselníček indikující pouze minuty.

**Tvar rámu i konstrukčních detailů** (horní část [kyvadlové](/slovnik/kyvadlo) tyče, závěrkové kolo [bicího stroje](/slovnik/bici-stroj) hodinového, výpustná páka bicího stroje čtvrťového) **svědčí o opuštění historizujících forem** a dokládá snahu o vytváření nového estetického názoru na ztvárnění konstrukčních prvků. Tento detail řadí stroj mezi modernější Kretschmerovy práce.

## Číselníky

Jeden **čtvercový číselník** o straně cca 210 cm, celoželezný. **Současný číselník nepůvodní** — zhotovila jej spolu s elektronickým hodinovým strojem firma Elektročas s.r.o. (Pragotron).
...
Hodinový stroj je ve **funkčním stavu**, ale **odpojen** od systému převodu točivého momentu k číselníkům, úhlový převodový strojek demontován. Ve věži osazeny elektronické hodiny.
