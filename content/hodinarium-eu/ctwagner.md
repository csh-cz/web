...
**Signálový stroj** se skládá z hnacího kola **H**, druhého kola **I**, středního kola **J** a [větrníku](/slovnik/vetrnik) **K**. Závaží **W1** je natahováno ve stejné době jako závaží **W2** pomocí vloženého kola mezi kola **F** a **N**. Na ose kola I je dvouramenná páka L s kontaktem G. Kontakt G se pohybuje mezi pružinovým kontaktem X, Y a Z. Kontakt X je připojen k baterii, kontakty Y a Z jsou připojeny k elektromagnetům podružných hodin a zároveň k natahovacím elektromagnetům **M**.
