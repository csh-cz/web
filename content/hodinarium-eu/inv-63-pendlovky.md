...
karta:
  ...
  stav: "funkční"
  extra:
    - { label: "Poznámka", value: "zápůjčka" }
---

<aside class="editor-note editor-note-warn" data-source-file="content/hodinarium-eu/inv-63-pendlovky.md" data-note-key="manual-edit-false" data-editor-only role="note" aria-label="Auto-import z legacy PHP">
