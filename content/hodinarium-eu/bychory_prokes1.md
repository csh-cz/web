...
Věžní hodinový stroj střední velikosti. Lucernové (cevové) pastorky (dodejme, že v době nálezu již nebyly otočné a někdy byly nahrazeny hřebíkem...), jednopákové vypouštění bicích strojů. Kyvadlová čočka litinová, kyvadlová tyč ocelová. Litinová závaží jsou zavěšena přes volné kladky na ocelových lanech. Na horní vodorovné pásnici kyvadlové strany hodinového stroje je čitelná signatura výrobce hodinového stroje s uvedeným letopočtem: Jan Prokeš v Sobotce 1868.
...
Na prvním obrázku je vidět zkrácené kyvadlo. Záměr byl, vystavit stroj ve výšce očí. Proto je dřevěná tyč kyvadla asi o metr kratší. Stroj je používán pouze k demonstračnímu chodu, nemá napojení ani na ciferník, ani na cimbály, tak snad rychlejší chod není tolik na závadu.

Na třetím obrázku je vidět Prokešova specialita - "kardanové kolečko" místo kardanova kříže. Kolečko zakončuje minutovou křídel procházející kyvadlem a slouží pro připojení tyče k rozvodovce.

Na pravé straně téhož obrázku je vidět převod 1:2 ze závěrkového kola na kolo pomocné spouštějící kolo, které pomocí stavitelných kolíků spouští dodatečný [zvonicí stroj](/clanky/bychory_zvonici_stroj).

Na čtvrtém obrázku je dobře vidět kyvadlový krok.

Na posledním obrázku bicího stoje celých hodin je také vlevo nahoře páka pomocného pohonu v době natahování jicího stroje. Páka se zapřela o zuby kola a pomocí (neautentického) závažíčka poháněla jicí stroj.
