...
tldr: 'Demonstrační exponát postavený kolem staršího rubidiového oscilátoru PRS10 (10 MHz), monitoru WEMOS D1 a hodin Arduino UNO odvozujících čas ze signálu PPS modulu GPS NEO-6M. Slouží k popularizaci principu atomových hodin.'
---
![PRS10 atomová část](/img/PRS10/PRS10stage3LG.jpg)

Pro Hodinárium v Děčíně stavíme jako exponát polofunkční model atomových hodin. Základem exponátu bude starší [rubidiový oscilátor PRS10](/projekty/prs10), který poskytuje výstupní frekvenci 10MHz s teoretickou přesností 10\-11. Této přesnosti pro stáří oscilátoru nebude dosaženo. I další použité levné technologie budou spíše jen simulovat skutečné funkce atomových hodin.
...
<img class="img-standalone" src="https://pub-e96bd8c658664b38af73a48cb8872b60.r2.dev/img/PRS10/hodiny1000.jpg" alt="Hodiny1000 HH:MM:SS.ms" />
...
<iframe src="https://orloj.eu/PRS2.php" width="100" height="1380" loading="lazy" allowfullscreen></iframe>
