...
![blokové schéma rubidiového frekvenčního oscilátoru SRS PRS10 — 10 MHz krystalový oscilátor v termostatu laděný 22bitovým D/A převodníkem přes varaktor na rubidiový přechod, RF syntezátor generuje cca 359,72 MHz, násobení 19× v diodě poskytuje mikrovlnnou frekvenci 6,834 GHz](/img/PRS10/AFM_2.gif)
