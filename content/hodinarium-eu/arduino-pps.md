...
tldr: 'Úvaha nad mezními možnostmi přesnosti Arduina synchronizovaného PPS signálem z GPS přijímače — od kalibrace interního oscilátoru až po náhradu rubidiovým frekvenčním normálem.'
---
