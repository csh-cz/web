...
Na podporu vystavení rubidiového oscilátoru v Hodináriu jsem vytvořil na platformě WEDOS doplněk, který obdobnou statistiku vytvoří a pošle na internetový server. Data získaná z rozhraní RS-232 a následně poslaná na server bude možné zobrazit na této [stránce](PRS2.php) nebo v následujícím okně. Bližší informace o jednotlivých povelech a hodnotách v [manuálu](https://www.thinksrs.com/downloads/pdfs/manuals/PRS10m.pdf). Signál PPS bude přiveden z přijímače NEO-6M GPS.
...
Text, program monitoru: Petr Král
