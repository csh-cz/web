...
tldr: 'Exponát části Nonsens — WeMos D1 s LCD 1602 zobrazuje NTP-synchronizovaný čas římskými číslicemi, doplněný „římským odbíjením" na dva gongy podle systému Josepha Knibba.'
---
...
![Digitální ukazatel minut na orloji v Benátkách — číslice se mění v pětiminutovém intervalu](/img/orloje/venecia/digitalky1.jpg)
...
Smysl byl, kromě toho že to bylo zajímavé, menší spotřeba energií, déle vydrželo natažení, bylo třeba méně úderů. Toto odbíjení navrhl anglický hodinář [Joseph Knibb](https://en.wikipedia.org/wiki/Joseph_Knibb). Následuje několik odkazů na aukční síně:
