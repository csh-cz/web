---
title: "Jubilejní výstava zemská 1891 — hodinářská sekce"
slug: "jubilejni-vystava-zemska-1891-hodinari"
...
tags:
  ...
  - cesko
  - praha
tldr: 'Největší cs průmyslová přehlídka 19. století v Praze. 17 vystavovatelů; centrem byla firma L. Hainz s věžními hodinami o 1400 dílcích. Datace pro Jana Mareše a Karla Adamce.'
manualEdit: true
...
sourceCharset: "utf-8"
scrapedAt: "2026-05-18T02:00:00.000Z"
---

V roce **1891** se v Praze konala **Zemská jubilejní výstava království Českého** — největší cs průmyslová přehlídka 19. století, sto let po jubilejní výstavě 1791. Hodinářskou sekci v pravém křídle paláce průmyslového popsal dobový katalog výstavy:

> „Výroba hodin zastoupena byla zdařile v pravém křídle paláce průmyslového, kde množství přesných a krásně pracovaných výrobků toho druhu kupilo se kolem velkolepé exposice věžních hodin Hainzových."
> — *Jubilejní výstava zemská království Českého v Praze 1891.* Hodinářský oddíl. [Google Books `S9tvQy_8o8EC`]

Tento jediný dochovaný popis hodinářské sekce poskytuje **vzácný snímek české hodinářské scény** koncem 19. století — 17 jmen s konkrétními exponáty, doložené roky aktivity a typologie produkce.

## Statistický kontext

Katalog uvádí klíčový kvantitativní údaj:

> „Kdežto v Čechách pracovali před sto lety jen 124 mistři hodinářští, přestoupil nyní počet jejich již 1000."

To dokumentuje **osminásobný růst počtu hodinářů v Čechách mezi lety 1791 a 1891** — odraz urbanizace, zámožnosti měšťanstva, masového rozšíření hodinek v 19. století a rozšíření výroby věžních hodin do malých obcí (kostely, radnice, školy, továrny).

## Vystavovatelé — průřez

### Velké firmy

**[L. Hainz, Praha](/hodinari/ludvik-hainz)** — největší exponát výstavy:
...
| Hodinář | Lokalita | Exponát |
|---|---|---|
| **[Jan Mareš](/hodinari/jan-mares)** | Poděbrady | „čtvrťovým strojem pro věžní hodiny" |
| **[Karel Adamec](/hodinari/karel-adamec)** | Čáslav | „dva čistě provedené vzorné stroje věžní" |

Pro oba je rok **1891 nejstarší jistá datace zralé dílny** — Mareše dosud v soupisu věžních hodin máme od roku 1886 (Slověč), Adamec až od 1910 (Čáslav).

### Astronomické a komplikované hodiny

> „Veškeru čest činily původci Bart. Štěpánovskému z Kolína veliké astronomické hodiny se zařízením vyrovnávacím v kyvadle."
...
Katalog dále poznamenává o struktuře výroby:

> „Kyvadlové hodiny v Čechách vyráběné těšily se druhdy dobré pověsti, a z dřevěných hodin toho druhu seznali hodinářství obyvatelé jižního Německa. Kvůli láci poklesla však tato výroba. V oboru ostatním brávají se součásti pro zboží horší jakosti ze Švýcarska, kdežto lepší zboží v tuzemsku se vyrábí."

Dva důležité technologické postoje této doby:

1. **České dřevěné kyvadlové hodiny** ovlivnily jihoněmecké hodinářství (Schwarzwald), ale **kvůli levné konkurenci poklesly**
2. **Hierarchie švýcarských součástek** — levné dílny dovážejí součástky, dražší (= prestižnější) tuzemská výroba je kompletní

Tento popis odpovídá **typickému stavu středoevropského hodinářství kolem 1890**: industrializace Švýcarska (La Chaux-de-Fonds, Le Locle) a Pforzheimu/Schwarzwaldu vytlačila tradiční tuzemskou ruční výrobu, lokální mistři se profilovali jako **kompletátoři** (montáž z dovezených dílů) nebo **luxusní specialisté** (vlastní design, velké hodiny, opravy).

## Poznámka k legendě o mnichu Gerbertovi

Dobový katalog 1891 ve svém úvodu uvádí tradiční legendu:

> „První hodiny se závažím sestavil benediktinský mnich Gerbert okolo r. 990, který později vstoupil na stolec papežský jako Sylvestr II."
...
Pro historickou rekonstrukci cs hodinářství 19. století je tento katalog **klíčový pramen** — jediné dochované strukturované hodnocení cs hodinářské produkce z období před první světovou válkou.

## Reference

- **Jubilejní výstava zemská království Českého v Praze 1891.** Hodinářský oddíl. Citace dostupná v digitalizované verzi na [Google Books](https://www.google.cz/books/edition/Jubilejn%C3%AD_v%C3%BDstava_zemsk%C3%A1_kr%C3%A1lovstv%C3%AD/S9tvQy_8o8EC?hl=en&gbpv=1&pg=PA587&printsec=frontcover), s. 587 a násl.
- **Nosonovsky, M.** *Early Renaissance Concepts of Time and the Invention of Mechanical Clocks.* 2024. (Zotero `RHHYLVK9`) — moderní výklad počátků mechanických hodin (vyvrácení gerbertovské legendy).
- **North, J.** *God's Clockmaker: Richard of Wallingford and the Invention of Time.* OUP 2005. (Zotero `NRN8RVQ9`) — kontextová monografie o vrcholu středověkého hodinářství.
- **Knespl, D.** *Progress versus Tradition – Traditional Craftsmanship and Attempts at Industrial Tower Clock Production in the Czech Lands in the 19th Century.* 2024. (Zotero `knesplProgressTraditionTraditional2024`) — analytická studie cs hodinářství 19. století (Prokeš, Hainz, Krečmer).
