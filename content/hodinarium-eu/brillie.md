...
Magnet speciálního tvaru zavěšený na konci těžkého půlsekundového kyvadla dostává od elektromagnetu jednostranný magnetický impulz v okamžiku, kdy rohatka postrkuje stroj. (Vypůjčená animace kroku [zde](/img/elektrika/ato/atopend.gif). ) U mechanických hodin je nejprve kyvadlo zbrzděno tím, že zabírá do stroje, následně je strojem urychleno. U elektromechanických hodin se úhly brzdění a urychlování kyvadla překrývají. Změna rychlosti kyvadla je minimalizovaná a hodiny mohou dosáhnout vyšší přesnosti. Reklamní tiskovina uvádí, že přesnost byla srovnatelná s přesností astronomických hodin. Dočetl jsem se, že hodiny Brillie byly používány v pařížské observatoři pro přenos časových signálů do podružných hodin.
...
Originální propojovací dráty probíhají na do zadní straně mramorové desky. Doba kyvu je regulována mosaznou koulí na závitové části kyvadlové tyče vyrobené pravděpodobně z Invaru. *![Matiční a podružné hodiny Brilie](/img/elektrika/brillie/Brillie_x2_m.jpg)*Kyvadlo jednostranně postrkuje hodinový stroj. Dvě malá železná jádra otočná podél cívky rozptylují magnetické pole a používají se pro doladění chodu hodin. Protože hodiny mají poměrně výrazný zvuk, byl pro rychlé nastavení doby kyvu použit program Clock Tuner na telefonu s OS Android. Vzhledem k tomu, že zvukově převažuje kyv na levou stranu, kdy stroj posunuje rohatku, byla jako referenční frekvence zvolena hodnota 3600 BPH (tj. 1 Hz). Ukázalo se, že nově vyrobené "pendl péro" je příliš dlouhé a nebylo již možné bez jeho zkrácení posunout těžiště kyvadla dostatečně vysoko. V současné době jdou hodiny s dostatečnou přesností.

Na obrázku vlevo podružné hodiny Brilié a mateční hodiny Brilié se signálovým kolem.

### Historie

Na stránkách www.brillie.co.uk se můžeme dočíst základní údaje o historii značky. Uvádí se, že v roce 1908 vynalezl francouzský fyzik Charles Féry hodiny, které se staly jejím základem. Lucien Brillie a Charle Le Roy pak společně přetvořili konstrukci Charlesa Feryho do hodin Brillie, jak je známe dnes. Společnost Brillie byla založena v roce 1897. Vznikla v Levallois v roce 1898 pod názvem Charles SNC Vigreux a Lucien Brillié. V roce 1900/1910 se společnost nazývala SNC Brillié Brothers. V letech 1912 nebo 1913 změnila svůj právní status, aby se stala SA Worksries Brillié Brothers, jménem, ​​které si zachovala až do konce své existence v roce 1981.
...
-   [O restaurování varianty se sekundovým kyvadlem](http://www.antiquity.in/brillie-1.html)
-   [O synchronizaci hodin Brillie pomocí DCF 77](http://f5mna.free.fr/h_mere%20Dossier/SYNCHRONISATION%20HORLOGE%20BRILLIE%20LE%20RETOUR%20VERSION%202.pdf)
