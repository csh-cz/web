...
Existují i přestavby, kdy naopak k historickému stroji je vytvořena nová schrána, aby lépe vynikla jeho technická krása. Případně k zachovanému torzu historicých hodin je zbytek dodělán buď v duchu původního díla, či jako nový svébytný prvek. Existují i přestavby, kdy vzniknou nové hodiny jako samostatný artefakt, pouze se použije části jiných hodin, nejčastěji sériově vyráběného stroje. A existují i přestavby, kdy z původních hodin zůstane zachováno jen jméno.

Přestavby hodin se tak nalézají kdekoliv na cestě mezi vkusem a nevkusem. Na mnoha jiných místech tohoto serveru většinou brojíme proti přestavbám historických hodin a naopak se přimlouváme za jejich nenásilné restaurování s co největší mírou zachování původního stavu. Vmontování elektronického stroje do starých hodin spíše nedoporučujeme, ale najdou se výjimky.

Naopak fandíme pokusům vytvořit nový časoměrný artefakt. Ať již jsou cílem nějaké unikátní hodiny pro speciální příležitost, podtržení krásy staré techniky nebo jde jen o výraz té nutkavé člověčí kreativity.
