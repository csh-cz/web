...
Jedna rafie na čtyřiadvacetihodinovém číselníku pravděpodobně původně ukazovala italský čas počítaný od západu Slunce. ( Případně český čas počítaný od východu Slunce. ) Po zavedení německého času počítaného od půlnoci se číselníky předělávaly. Současný táborský orloj jednou rafií ukazuje SEČ na číselníku s číslicí 24 nahoře.

Jsme muzeum virtuální, proto i na této stránce ukazujeme **animovaný číselník v reálném čase**. Orloj ukazuje SEČ v okamžiku otevření stránky a každou půlminutu se aktualizuje. Vlevo nahoře jsou kontrolní digitálky — při srovnání obou údajů je hned vidět ta podivuhodnost jediné pomalu obíhající rafije.
