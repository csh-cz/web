...
Každé staré hodiny s 24 hodinovým číselníkem se někdy nazývaly orloje.
...
Dnes věžní hodiny mají obvykle dvě ručičky. Malou a velkou. Používat zdrobněliny pro označení objektů několikametrových je specialitou češtiny. Proto nebudeme jediné "ručce" orloje na věži bývalé radnice v Táboře říkat malá ručička, ale hodinová ručka. Má sice podobu opravdové ručičky, je to však pořádná pracka.

Jedna ručka na čtyřiadvacetihodinovém číselníku pravděpodobně původně ukazovala italský čas počítaný od západu Slunce. ( Případně český čas počítaný od východu Slunce. ) Po zavedení německého času počítaného od půlnoci se číselníky předělávaly. Současný táborský orloj jednou ručkou ukazuje SEČ na číselníku s číslicí 24 nahoře.

Jsme muzeum virtuální, proto i na této stránce ukazujeme **animovaný číselník v reálném čase**. Orloj ukazuje SEČ v okamžiku otevření stránky a každou půlminutu se aktualizuje. Vlevo nahoře jsou kontrolní digitálky — při srovnání obou údajů je hned vidět ta podivuhodnost jediné pomalu obíhající ručky.
