...
Tuto metodu také u vidíte (doufejme) na serveru [www.time.gov](http://www.time.gov/) Nepřehlédněte obrázek světa s vyznačením pásem dne a noci. To jsou vlastně také hodiny, protože i tento obrázek "jde", respektive se mění podle času. Pokud bychom na obrázek doplnily 24 hodinovou pohyblivou časovou osu, vzniknou univerzální hodiny, které pro každé místo na zemi ukazují správný sluneční čas. Tento čas se ovšem liší od času, který platí v daném časovém pásmu.
