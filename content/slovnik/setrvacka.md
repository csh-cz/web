...
Setrvačka funguje na principu **torzního oscilátoru** (na rozdíl od kyvadla, které využívá gravitaci). Je tvořena drobným kolem (typicky 7–15 mm v průměru) na hřídelce, jejíž torzní pohyb je regulován **vláskem** (vlasovou pružinkou) — pravidelné rotační kmity setrvačky dávají časový etalon pro krok.

Vynalezl ji v 17. století **Christiaan Huygens** (1675) společně s vláskem — předtím se v kapesních hodinkách používal lihýř (foliot) bez pružinky, hodinky tedy závisely na orientaci vůči gravitaci.

Konstrukční typy:
- **Jednoduchá setrvačka** — z mosazi, bez kompenzace
