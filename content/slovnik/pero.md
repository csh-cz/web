...
prekladyFr:
  ...
  - term: grand ressort
    zdroj: Gros 1913
definice: "Pohonná pružina svinutá v perovníku, která svým rozvíjením přenáší energii na soukolí; primární zdroj síly v kapesních a stolních hodinách (na rozdíl od závaží u věžních a stojacích)."
pribuzne:
  - perovnik
  - snek
---
...
Tažné péro je **uskladňovač mechanické energie** — natažení péra konzumuje energii (otáčením korunky nebo natahovacím klíčem), rozvíjení péra ji postupně vrací do soukolí.
...
Synonyma:
- **„hlavní péro"** (Sušický 1900) — primární pohonné péro (na rozdíl od pomocného v remontoiru)
- **„tažné péro"** (Sladkovský 1947) — moderní cs primární
- **„p. hodinní"** (Šumavský 1851 — Uhrfeder)
- **„p. bicí"** (Sušický 1900 — Schlagfeder, pro bicí soukolí)

Špatný 1882 razil **„zpruha"** jako české synonymum pro pružinu obecně (Feder); v hodinářském kontextu zůstalo **„péro"** (kvůli tradici).

**Komponenty:**
- **Růže** (Sušický 1900) — vnitřní konec péra zachycený háčkem v duši perovníku
- **Vnější konec** — zachycen v obvodu perovníku, předává tah na ozubení

## Příbuzné termíny

[perovník], [stavítko], [šnek (závitek)], [remontoir], [zpruha]
