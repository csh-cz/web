...
| **den hodinní** | astronomický den / 24h | Uhrtag |
| **hák anglický** | kotvový krok | englischer Haken |
| **spravovací stroj v hodinkách** | krok (obecně) | die Hemmung |
| **spravovák** | regulátor | Regulator |
| **komítací hodiny** | kyvadlové hodiny | Pendeluhr |
| **pršící hodiny** | přesýpací hodiny | Sanduhr |
| **kolostroj** | soukolí | Räderwerk / Uhrwerk |
| **kyvadlo** *(zahrnuje i setrvačku)* | kyvadlo nebo setrvačka | Pendel + Unruhe (smícháno) |
| **závěšadlo** | kyvadlo | Pendul |
| **krokvička** | kyvadlo (drobné) | Pendul |
| **kolisadlo** | kyvadlo | Pendel |
| **kyvák** | kyvadlo | Pendel |
| **rafika** / **rafije** | ručička / ručka | Uhrzeiger |
| **větrober** | větrník (bicího stroje) | Windfang |
| **kotejsadlo** | (nářadí pro řezání šneku) | Schneckenschneidezeug |
| **kuželíček** | (= levotočivý šroub) | Linksschraube |
| **vláločit** | (sloveso — vsadit, lapovat) | einlappen |
| **postupné kolo** | krokové kolo bicího stroje | Steigerad |
| **zdvihací kolo** | (zvonící kolo, zvedá kladívko) | Heberad |
| **postupováček** | stavítko | Stellung im Uhrwerke |
| **pero vlasové** *(adjektivní)* | vlásek | Haarfeder |
| **stroj hodinkový** | hodinový stroj | Uhrwerk |
| **hodiny bicí** | bicí hodiny | Schlaguhr |
| **hodiny překlopní** | (= flip clock 17–18 stol.) | Sturzuhr |
| **hodiny s pluňkou** | (= harf clock s rezonancí) | Harfenuhr |

### Tři kuriozitní archaismy s vlastní mini-sekcí

#### **časoměr** = chronometr / metronom

Šumavského český purismus pro chronometr **i hudební metronom** —
oba pod jedním slovem, sjednocujícím „přesný měřič času". Etymologie:
**čas + měr** (= měřítko). Moderní cs „chronometr" je fonetický kalk
z řec. χρονόμετρον. Šumavského „časoměr" se neujalo, ale derivované
„časoměřičství" zachováno (souběžné se „chronometrie").
...
v dobových technických textech 1850–1880.

#### **pršící hodiny** = přesýpací

Šumavského krásný archaismus z **„prš"** (drobný déšť, sypání).
Sand padá jako prachový déšť → „pršící hodiny". Moderní cs
„přesýpací" nebo „písečné" — ani jedno nereflektuje původní
poetiku. Pršící hodiny zůstávají v Šumavském jako **hapax** —
neobjeví se v Špatném 1882 ani v moderní cs.
...
Většina hesel slovníku má cross-link na
Šumavského ekvivalent v sekci „Reference".

**Kompletní inventář (36 termínů):**
[`~/.claude/skills/horologicka-terminologie/reference/glosar.yaml`](/Users/dknespl/.claude/skills/horologicka-terminologie/reference/glosar.yaml)
— pro každý termín strukturovaný YAML záznam s cs, de, en, fr,
poznámkami a referencemi.
...
> „Šumavský 1851 NEMÁ slovo „krok" v hodinářském smyslu ani „setrvačka"
> — Špatný 1882 byl primárním tvůrcem moderní české hodinářské
> terminologie."
> — Pozn. v `~/.claude/skills/horologicka-terminologie/reference/k-overeni.md`,
> sekce 11 (Šumavský 1851 — VYŘEŠENO 2026-05-08).
