# Dead-link audit — 2026-06-21

Vygenerováno skriptem `scripts/audit-dead-links.mjs` 2026-06-21T08:23:54Z.
...
- **Neověřené (5xx / timeout / blokace):** 33
...
## Mrtvé odkazy (7 unikátních URL ve 7 souborech)
...
- **HTTP 404** — http://www.clockguy.com/SiteRelated/SiteReferencePages/LenzkirchHistory.html
  ...
  - 📦 **Wayback Machine snapshot:** http://web.archive.org/web/20250424010251/https://www.clockguy.com/SiteRelated/SiteReferencePages/LenzkirchHistory.html (20250424010251)
  - Rozhodnutí: _REPLACE / REMOVE — doplň_
...
- **HTTP 403** — http://digifolio.rvp.cz/user/view.php?id=1411
  - Pole: `body:link`
  - Kontext: …book.com. [cit. 2026-04-28] - [Metodický portál - inspirace a zkušenosti učitelů](http://digifolio.rvp.cz/user/view.php?…
  - 📦 **Wayback Machine snapshot:** http://web.archive.org/web/20250126135831/https://digifolio.rvp.cz/user/view.php?id=1411 (20250126135831)
  - Rozhodnutí: _REPLACE / REMOVE — doplň_
...
- http://www.webx.dk/oz2cpu/clock-scope/scope.htm _(fetch failed)_
