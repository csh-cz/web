...
export const akce: Akce[] = [
  ...
  // ─── MINULÉ ───
  {
    ...
    detail:
      ...
      + 'target="_blank" rel="noopener">Stránka výstavy na vmo.cz <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></p>'
      + '<h2>Účast spolku</h2>'
      + '<ul>'
      ...
      + 'target="_blank" rel="noopener">PDF&nbsp;<i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a>'
      + '</p>'
      + '<p class="citation">'
